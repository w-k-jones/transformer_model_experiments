"""
A masked autoencoder model based on MAE and ViT-5 for CloudSat reconstruction using flexattention and windowing
"""
...
class GeoCloudSatFlexTransformer(GeoMaskedAutoEncoder):
    def __init__(self, *args, output_dim=125, prediction_head=None, **kwargs):
        super().__init__(*args, **kwargs)
        
        # Decoder blocks with mask attention
        self.decoder_attn = partial(flex_attention, block_mask=None)
